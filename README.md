...
| `/earnings` | **Today** or **this week** earnings (FinViz Elite); sorted by **mkt cap** then **session** (BMO/AMC-style); time, price, volumes, change % |
...
| `/earnings [period]` | **Today** or **Weekly** earnings (**v=152**); sort **-marketcap** then BMO/AMC-style session; monospace table; needs `FINVIZ_API_KEY` |
